...
```
;v0.3.1-draft 判讀紀律六律(雙盲#1 五缺口+Simon 以小觀大),A 集團裁定內坎(半象)
```
...
```markdown
| 07-22 | **八態鏡 v0.3.1·判讀紀律六律**(雙盲#1 出土五缺口+以小觀大;A 集團裁定內坎半象;證據純化/爻疑/成爻門檻/歸格例句庫/次型註記) |
```
